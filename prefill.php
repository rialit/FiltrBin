...
$fields = [
    'author_name' =>            ['Your name',             'Serg',                                                ''],
    'author_github_username' => ['Your GitHub username',  '<rialit> in https://github.com/rialit',       ''],
    'author_email' =>           ['Your email address',    'r1al1t@mail.ru',                                                ''],
    ...
    'package_vendor' =>         ['Package vendor',        '<FiltrBinary> in https://github.com/rialit/FiltrBinary',   '{author_github_username}'],
    'package_name' =>           ['Package name',          '<Binary> in https://github.com/rialit/FiltrBinary',  ''],
    'package_description' =>    ['Package very short description',   '',                                     ''],

    'psr4_namespace' =>         ['PSR-4 namespace',       'usually, FiltrBin\\FiltrBinary',                        '{package_vendor}\\{package_name}'],
];
